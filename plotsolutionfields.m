...
subplot(4,1,4)
hold off
semilogx(out.periods, out.spectrum, 'color', blue, 'linewidth', 1)
hold on
semilogx(out.periods, out.spectrum2, 'color', red, 'linewidth', 1)
set(gca,'color',grey)
xlim([.1 100])
grid on
xlabel('Period (s)')
ylabel('amplitude spectrum')
legend('Chamber pressure','Conduit bottom')
