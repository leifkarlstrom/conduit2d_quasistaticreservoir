...
h = dt;
k1 = y0;
b = (y0 + a21*h*f(k1,t+c1*h) + ia21*h*A*k1);
k2(q) = U\(L\b(p));
k2 = k2';
b  =(y0 + a31*h*f(k1,t+c1*h) + a32*h*f(k2,t+c2*h) + ...
     ...
             ia31*h*A*k1 + ia32*h*A*k2);
k3(q) = U\(L\b(p));
k3 = k3';
b = (y0 + a41*h*f(k1,t+c1*h) +  a42*h*f(k2,t+c2*h) + ...
             a43*h*f(k3,t+c3*h) + ...
             ...
             ia41*h*A*k1 + ia42*h*A*k2 + ia43*h*A*k3);
k4(q) = U\(L\b(p));
k4 = k4';
b = (y0 + a51*h*f(k1,t+c1*h)   + a52*h*f(k2,t+c2*h) + ...
             a53*h*f(k3,t+c3*h)   + a54*h*f(k4,t+c4*h) + ...
              ... 
             ia51*h*A*k1 + ia52*h*A*k2 + ia53*h*A*k3 + ia54*h*A*k4);
k5(q) = U\(L\b(p));
k5 = k5';
b =(y0 + a61*h*f(k1,t+c1*h)   + a62*h*f(k2,t+c2*h) + ...
